...
/**
 * <p>Indicates that the pagination should be restarted from the beginning.
 * This may for example occur when a change in the page layout is
 * triggered, such as changing from footnotes (at the bottom of the page)
 * to end notes (at the end of volumes). If this exception
 * is thrown, then all previously successful sequences could be compromised.</p>
 * 
